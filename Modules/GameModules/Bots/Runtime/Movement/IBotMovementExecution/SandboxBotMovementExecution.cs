...
{
    internal class SandboxBotMovementExecution : IBotMovementExecution
    {
        private readonly IBotInputMimic _input;
        private readonly CollisionsDetector _collisionsDetector;

        public SandboxBotMovementExecution(IBotInputMimic botInputMimic, CollisionsDetector collisionsDetector)
        {
