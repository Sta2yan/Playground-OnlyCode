...
{
    public class NewYearEventMovementRouter : IGameLoop, IGameFixedLoop, IMovementRouter
    {
        ...
        public NewYearEventMovementRouter(IInput input, IDisplacementObject movement, ICameraMovement camera)
        {
            _input = input;
            _movement = movement;
            _camera = camera;
