...
{
    public class ObbyMovementRouter : IGameLoop, IGameFixedLoop, IMovementRouter
    {
        ...
        public ObbyMovementRouter(IInput input, IDisplacementObject movement, ICameraMovement camera)
        {
            _input = input;
            _movement = movement;
            _camera = camera;
