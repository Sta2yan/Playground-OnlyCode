...
{
    public class SandboxMovementRouter : IGameLoop, IGameFixedLoop, IMovementRouter
    {
        ...
        public SandboxMovementRouter(IInput input, IDisplacementObject movement, ICameraMovement camera)
        {
            _input = input;
            _movement = movement;
            _camera = camera;
